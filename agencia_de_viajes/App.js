...
const App = () =>{
  ...
  const [modalVisibleturismo, setModalVisibleturismo] = useState(false);
 return(
 <>
  ...
  <Modal transparent={true} animationType="slide" visible={modalVisiblepupusa} onRequestClose={() => {
    ...
    <View style={styles.vistaModal}>
      <View style={styles.Modal}>
        ...
        <Text>Las deliciosas pupusas de El Salvador es la comida principal del pequeño país.</Text>
        <Button title="Cerrar" onPress={()=>{setModalVisiblepupusa(!modalVisiblepupusa)}}></Button>
      </View>
    </View>
  </Modal>

  <Modal transparent={true} animationType="slide" visible={modalVisibleturismo} onRequestClose={() => {
    alert('Modal has been closed.');
  }}>
    <View style={styles.vistaModal}>
      <View style={styles.Modal}>
        <Text style={styles.subtitulo}>Concepcion de Ataco</Text>
        <Text>Ataco es un distrito en Ahuachapan, se conoce por celebrarse el día de los farolitos. Una tradicion que lleva mas de 200 años vigente.</Text>
        <Button title="Cerrar" onPress={()=>{setModalVisibleturismo(!modalVisibleturismo)}}></Button>
      </View>
    </View>
  </Modal>
...
<View style={styles.listado}>
  ...
  <TouchableHighlight onPress={()=>{setModalVisibleturismo(!modalVisibleturismo)}}>
    <Image 
    style={styles.mejores}
